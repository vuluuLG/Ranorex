...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Run application 'C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\Notepad++.lnk' in normal mode. Return value bound to $varPathSoftware.", new RecordItemIndex(0));
            varPathSoftware = ValueConverter.ToString(Host.Local.RunApplication("C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\Notepad++.lnk", "", "", false));
