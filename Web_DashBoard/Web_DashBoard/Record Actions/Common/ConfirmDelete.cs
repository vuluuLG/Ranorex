...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'Popup.ButtonOK' at Center.", repo.Popup.ButtonOKInfo, new RecordItemIndex(1));
            repo.Popup.ButtonOK.Click();
            Delay.Milliseconds(0);
