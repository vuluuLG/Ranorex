...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("ef1bfdc0-7026-486d-9ee1-d81021ca167d", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'TADashboard'.", repo.TADashboard.SelfInfo, new RecordItemIndex(0));
            Host.Current.CloseApplication(repo.TADashboard.Self, new Duration(0));
