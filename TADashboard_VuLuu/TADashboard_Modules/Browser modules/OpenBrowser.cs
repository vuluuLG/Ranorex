...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            // Open browser
            Report.Log(ReportLevel.Info, "Website", "Open browser\r\nOpening web site '$pageUrl' with browser '$browser' in maximized mode.", new RecordItemIndex(0));
            Host.Current.OpenBrowser("$pageUrl", "$browser", "", false, true, false, false, false, true);
