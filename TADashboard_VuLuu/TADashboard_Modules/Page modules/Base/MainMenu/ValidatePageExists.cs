...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            try {
                Report.Log(ReportLevel.Info, "Wait", "(Optional Action)\r\nWaiting 5s to exist. Associated repository item: 'TADashboard.Pages.BasePage.MainMenu.LnkPageTab'", repo.TADashboard.Pages.BasePage.MainMenu.LnkPageTabInfo, new ActionTimeout(5000), new RecordItemIndex(0));
                repo.TADashboard.Pages.BasePage.MainMenu.LnkPageTabInfo.WaitForExists(5000);
            } catch(Exception ex) { Report.Log(ReportLevel.Warn, "Module", "(Optional Action) " + ex.Message, new RecordItemIndex(0)); }
            
            Report.Log(ReportLevel.Info, "Validation", "Validating Exists on item 'TADashboard.Pages.BasePage.MainMenu.LnkPageTab'.", repo.TADashboard.Pages.BasePage.MainMenu.LnkPageTabInfo, new RecordItemIndex(1));
            Validate.Exists(repo.TADashboard.Pages.BasePage.MainMenu.LnkPageTabInfo);
